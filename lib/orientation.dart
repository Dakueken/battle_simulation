...
void main() => runApp(const TestOrientation());

class TestOrientation extends StatefulWidget {
  const TestOrientation({super.key});

  @override
  TestOrientationState createState() => TestOrientationState();
}

class TestOrientationState extends State<TestOrientation> {
    ...
    return MaterialApp(
      home: Scaffold(
        ...
        body: NativeDeviceOrientedWidget(
          landscape: (context) {
            return const Center(
              child: Text('Native Orientation: Landscape (Unknown Side)\n'),
            );
          },
          ...
          portraitUp: (context) {
            return const Center(
              child: Text('Native Orientation: Portrait Up\n'),
            );
          },
          portraitDown: (context) {
            return const Center(
              child: Text('Native Orientation: Portrait Down\n'),
            );
          },
          fallback: (context) {
